...
\begin{figure}[htbp]
    ...
    % TODO Make bigger and make colours match the correct colour scheme. Don't need Subfigures since axes are shared and subtitles are actual titles.
\end{figure}
...
\begin{figure}[htbp]
    ...
    % Make MSE instead of RMSE and fix the size. X-axis should read the same as in previous simulation figures. The difference line is not needed.
\end{figure}
...
\begin{figure}[htbp]
    ...
    % Use points not x's, and make the figure bigger.
\end{figure}

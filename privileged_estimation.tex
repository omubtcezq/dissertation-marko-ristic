...
\subsection{Multi-sensor Problem}
...
\subsection{Measurement Modification}\label{subsec:adding_privilege_noise}
...
\subsection{Security Analysis}\label{sec:scheme_security}
...
%  ######  #### ##     ## 
% 
\subsection{Simulation}\label{sec:simulation_priv}
...
\subsection{Distribution of Noise Terms}\label{subsec:noise_dist}
...
%  ######  ##     ##    ##    ##           ##     #######  
% 
\subsection{Security Analysis}\label{sec:crypto}
...
\section{Conclusions on Provable Estimation Performances}

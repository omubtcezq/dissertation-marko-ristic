...
\begin{titlepage}
    ...
    \begin{center}
        ...
        \vspace{0.5\baselineskip}
        vorgelegt der Fakultät für Informatik der Otto-von-Guericke-Universität Magdeburg von
    ...
    \LARGE
    \noindent
    \textbf{Ehrenerklärung}

    \vspace{1cm}
    \large
    \noindent
    I hereby certify that I have prepared this thesis without the unauthorized assistance of third parties and without the use of resources other than those indicated; external and my own sources used are identified as such. In particular, I have not used the help of a commercial doctoral advisor. Third parties have neither directly nor indirectly received monetary benefits from me for the work related to the content of the submitted dissertation.

    \vspace{0.5cm}
    \noindent
    In particular, I did not knowingly:
    \begin{itemize}
        \item invent any results or conceal contradictory results,
        \item intentionally misuse statistical procedures to interpret data in an unjustified manner,
        \item plagiarize other people's results or publications,
        \item distort the results of other research.
    \end{itemize}

    \vspace{0.5cm}
    \noindent
    I am aware that violations of copyright law may give rise to injunctive relief and claims for damages by the author as well as criminal prosecution by the law enforcing authorities. The work has not yet been submitted as a dissertation in the same or similar form either in Germany or abroad and has not yet been published as a whole.

...
\end{equation}
Similarly, encryption $\mathcal{E}_{\mathsf{pk}}(\cdot)$, decryption $\mathcal{D}_{\mathsf{pk},\mathsf{sk}}(\cdot)$ and the above operators $\oplus$ and $\otimes$ will denote elementwise opertaions when inputs are multi-dimensional.

...
Cryptographic notions are formal mathematical constructs used to prove the security of cryptographic schemes. A cryptographic notion captures the capabilities of attackers that are considered and the accepted leakage of information, that is, what an attacker can do and what they can learn. A notion is specific to a type of scheme, typically defined by a set of algorithms [], and when such a scheme is proved to meet the cryptographic notion it is mathematically guaranteed that any attacker with the capabilities specified by the notion cannot gain more information than the leakage specified by the notion.
